...
# Load dataset
df = pd.read_csv(r"C:\Users\Meghana\Desktop\MCA Final Demo\Courses\ufinal.csv")
...
def filter_recommendations(skill_query, recommendations):
    ...
    if skill_query in ["c plus plus", "c++"]:
        # Add default C++ courses
        default_cplusplus_courses = [
            {"title": "C++ Training Crash Course for C++ Beginners", "score": 0.9, "rating": 4.5},
            {"title": "C++ Complete Training Course for C++ Beginners All In One", "score": 0.83, "rating": 4.3}
        ]
